...
gg.editAll("120",gg.TYPE_FLOAT)
gg.clearResults()
gg.toast("Wallhack SD 650/660 Activated")
end
function WH5()
gg.clearResults()
gg.setRanges(gg.REGION_BAD)
...
function HO3()
  ...
  gg.clearResults()
  gg.toast("Neo Head Magic Bullet Activated")
end
function HO4()
  gg.setRanges(gg.REGION_BAD)
  gg.searchNumber("-88.66608428955;26:512", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
